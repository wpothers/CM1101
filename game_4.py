...
def exit_leads_to(exits, direction):
    ...
    'Reception'
    """
    #get the name of the room from the input
    name_of_room = exits.get(direction)
    #turn the name into the dictionary name using the rooms dictionary
    dic_name = rooms[name_of_room]
    #use the dictionary name to find the actual name of the room
    actual_name = dic_name["name"]
    return(actual_name)
...
def menu(exits):
    ...
    while True:
        ...
        # Normalise the input
        normalised = normalise_input(players_input)
        user_input = normalised[3:]
...
def move(exits, direction):
    ...
    dic_name_new_room = rooms.get(new_room)
    return(dic_name_new_room)
